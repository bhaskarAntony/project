  ...
  return (
    <section className='contact bg-blur '>
        <div className="banner bg-banner">
            <h2 className="heading text-white text-center">Contact Us for Your Transportation Needs</h2>
            <p>Ready to experience top-notch transportation services? Contact RSR Tours today for car rentals, hourly rentals, airport taxi services, local taxi rides, and outstation journeys. Your journey with us begins here.</p>
        </div>
      ...
      <div className="mt-5 container">
        <h1 className="fs-1 text-center my-5 text-900">Contact Information:</h1>
