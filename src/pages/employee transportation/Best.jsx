    ...
    <section className='best-features p-lg-5 p-3 bg-light-blue'>
        ...
        <div className="row align-items-center">
            ...
            <div className="col-12 col-sm-12 col-md-6">
                <img src="https://img.freepik.com/free-photo/business-couple-traveling-by-train_329181-13734.jpg?size=626&ext=jpg&ga=GA1.1.874872603.1694171926&semt=ais" alt="" className="w-100" />
            </div>
        </div>
    </section>
  )
