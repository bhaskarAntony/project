    ...
    <div className='container-fluid hero py-2'>
            ...
            <div className="col-12 col-md-12 col-lg-6">
                <div className="hero-left p-lg-3 p-4 px-lg-4">
                    ...
                    <p className='subtitle mt-4 text-lighter'>Car rental taxi service- <span className="text-main fw-bold">RSR Tours and Travels. </span>We Providing best Outstation Cab Services, Hourly car rental, Airport taxi, Employee Transportation and Luxury car Rental service in and around karnataka.
                    ...
                    <div className='mt-4'>
                    <button className="main-btn bg-black hero-btn">Book <i class="bi bi-chevron-double-right"></i></button>
                    <button className="main-btn  mx-lg-3 hero-btn">Learn More<i class="bi bi-chevron-double-right"></i></button>
                    </div>
                </div>
                </div>
              <div className="col-12 col-md-12 col-lg-6">
