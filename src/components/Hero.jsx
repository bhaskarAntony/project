    ...
    <div className='container-fluid hero'>
            ...
            <div className="col-12 col-md-12 col-lg-6">
                <div className="hero-left p-lg-3 p-4 px-lg-4">
                    <h1 className="heading text-black text-900" text-900>Explore OutStanding <span className="text-main">Cabs, Airport Taxi, Luxury cars in Bangalore</span></h1>
                    <p className='subtitle mt-4'>Car rental taxi service- <span className="text-main fw-bold">RSR Tours and Travels. </span>We Providing best Outstation Cab Services, Hourly car rental, Airport taxi, Employee Transportation and Luxury car Rental service in and around bangalore city.
