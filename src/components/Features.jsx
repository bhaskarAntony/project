...
function Features() {
  return (
    <div className='container'>
      ...
      <p className='subtitle'>Discover a world of convenience, safety, and customization, paving the way for unforgettable adventures <br /> and seamless mobility solutions.</p>
      </div>
      <div className="row p-3">
        <div className="col-12 col-md-12 col-lg-4">
            <div className="feature mt-2">
                ...
                <div className="f-body">
                    <p className='card-heading'><b>First class services</b></p>
        ...
        <div className="col-12 col-md-12 col-lg-4">
            <img src="https://www.madebydesignesia.com/themes/rentaly/images/misc/car.png" alt="" className='w-100 anim-img' />
        </div>
            <div className="col-12 col-md-12 col-lg-4">
            <div className="feature mt-2">
                <div className="f-icon float-lg-end mx-2 mb-3">
            ...
            <div className="feature mt-5">
                ...
                <div className="f-body">
                    <p className='card-heading'><b>Free Pick-Up & Drop-Off</b></p>
